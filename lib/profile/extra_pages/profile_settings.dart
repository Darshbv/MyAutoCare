...
class _ProfileSettingsState extends State<ProfileSettings> {
  ...
  getProfileUpdatedDetails({
    ...
    var request = http.MultipartRequest('POST', Uri.parse('http://myautocare.in/admin/api/updateuser'));
    ...
    request.files.add(await http.MultipartFile.fromPath('cover',_coverImage.path));
    ...
    if (response.statusCode == 200)
    {
      ...
      Navigator.pushReplacement(context, MaterialPageRoute(builder: (context)=>ProfileSettings()));
                ...
                Column(
                  ...
                  children: <Widget>[
                        ...
                        Container(
                          ...
                          borderRadius: BorderRadius.circular(10),
                              ...
                              child:_coverImage == null
                                  ...
                                  : Image.file(_coverImage,width: 0.4*MediaQuery.of(context).size.width,
                      ...
                      children: [
                        ...
                        Row(
                          ...
                          children: [
                            ...
                            _profileImage==null?Container():SizedBox(
                    ...
                    TextFormField(
                      ...
                      keyboardType: TextInputType.text,
                      validator: (String value){
                        return value.isEmpty?'Location cannot be empty':null;
                      },
                    ),
                    SizedBox(
                      height: 30.0,
                    ...
                    SizedBox(
                      ...
                      child: RaisedButton(
                        ...
                        onPressed: ()async{
                          ...
                          print(user_id);
                          await getProfileUpdatedDetails(fname: firstName.text,
                            lname: lastName.text,
                            id:user_id,
