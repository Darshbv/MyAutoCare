...
PostUserMedia postUserMediaFromJson(String str) => PostUserMedia.fromJson(json.decode(str));

String postUserMediaToJson(PostUserMedia data) => json.encode(data.toJson());
...
class PostUserMedia {
  ...
  factory PostUserMedia.fromJson(Map<String, dynamic> json) => PostUserMedia(
    code: json["code"],
