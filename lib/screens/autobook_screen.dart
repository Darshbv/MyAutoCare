...
class _AutoBookScreenState extends State<AutoBookScreen> {
  ...
  Future<LikePost> showLikeButton(String session_id, String post_id) async {
    var response = await http.post(
        "http://myautocare.in/Socialmedia/mobile_api/like_post",
  ...
  Future<bool> repostButton(String session_id, String post_id) async {
    var response = await http.post(
        "http://myautocare.in/Socialmedia/mobile_api/publication_repost",
        body: {"session_id": session_id, "post_id": post_id});
    if (response.statusCode == 200) {
      print("Retweet");
      return true;
                      ...
                      child: Column(
                        ...
                        children: [
                                  ...
                                  children: [
                                    Container(
                                      ...
                                      child: Padding(
                                        ...
                                        child: CircleAvatar(
                                          radius: 35.0,
                                          backgroundImage: NetworkImage(autoBook
                                              .data.feeds[index].owner.avatar),
                                        ),
                                      ),
                                    ),
                                    Padding(
                                      ...
                                      child: Column(
                                        ...
                                        children: [
                                          Padding(
                                            padding: const EdgeInsets.all(2.0),
                                            child: Text(
                                              utf8convert(autoBook
                                                  .data.feeds[index].owner.name
                                                  .toString()),
                                              style: TextStyle(
                                                  color: Colors.white,
                                          ...
                                          Padding(
                                            padding: const EdgeInsets.all(2.0),
                                            child: Text(
                                              autoBook.data.feeds[index].time,
                                              style: TextStyle(
                                                  color: Colors.white,
                                                  fontSize: 14,
                                                  fontWeight: FontWeight.bold),
                          ...
                          Padding(
                            padding: const EdgeInsets.all(8.0),
                            child: Text(
                              utf8convert(autoBook.data.feeds[index].text),
                              style: TextStyle(
                                color: Colors.white,
                                fontSize: 17,
                                fontWeight: FontWeight.bold,
                          ...
                          autoBook.data.feeds[index].media.length == 0
                              ? Container()
                              : Container(
                                  height: 150,
                                  ...
                                  child: ListView.builder(
                                      ...
                                      shrinkWrap: true,
                                      itemCount: autoBook
                                          .data.feeds[index].media.length,
                                      itemBuilder: (context, index2) {
                                        return autoBook.data.feeds[index]
                                                    .media[index2].type ==
                                                "image"
                                            ? Padding(
                                                padding:
                          ...
                          Padding(
                            padding: const EdgeInsets.all(8.0),
                            child: Text(
                              "${autoBook.data.feeds[index].likesCount} Likes "
                              "${autoBook.data.feeds[index].replysCount} Comments",
                              style: TextStyle(
                                  color: Colors.white,
                                  fontWeight: FontWeight.bold),
                            ),
                              ...
                              children: [
                                Row(
                                  children: [
                                    ...
                                    Text(
                                        autoBook.data.feeds[index].hasLiked
                                            ? "UNLIKE"
                                            : "LIKE",
                                        style: TextStyle(
                                            color: autoBook
