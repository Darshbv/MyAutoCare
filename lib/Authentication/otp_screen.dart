  ...
  get _getInputPart {
    return new Column(
      ...
      children: <Widget>[
        ...
        _getEmailLabel,
        _getInputField,
        _hideResendButton ? _getTimerText : Text(""),
        _getResendButton,
        _getOtpKeyboard
      ],
    );
    ...
    return new Container(
      ...
      child: Row(
        ...
        children: [
          ...
          _hideResendButton?Text(
            "Resend OTP",
            style:
            new TextStyle(fontWeight: FontWeight.bold, color: Colors.grey,fontSize: 18),
          ):Text(
            "Resend OTP",
            style:
            new TextStyle(fontWeight: FontWeight.bold, color: Colors.red,fontSize: 18),
          ),
        ],
      ),
    );
