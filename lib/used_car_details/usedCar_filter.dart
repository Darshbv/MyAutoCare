...
class UsedCarFilter extends StatefulWidget {
  @override
  _UsedCarFilterState createState() => new _UsedCarFilterState();
}

class _UsedCarFilterState extends State<UsedCarFilter> {
  //Radio//
  int _groupValue = -1;
            ...
            children: [
              ...
              ExpansionTile(
                ...
                onExpansionChanged: (bool expanding) =>
                    setState(() => this.isExpanded1 = expanding),
                children: [
                  Column(
                          ...
                          Padding(
                            ...
                            child: Container(
                              ...
                              child: Padding(
                                padding: const EdgeInsets.all(8.0),
                                child: Text(
                                    "${_lowValue.toInt().toString()}  Lakhs"),
                              ),
                            ),
                          ),
                          Padding(
                            ...
                            child: Container(
                              ...
                              child: Padding(
                                padding: const EdgeInsets.all(8.0),
                                child: Text(
                                    "${_highValue.toInt().toString()}  Lakhs"),
                              ),
                            ),
                          ),
                        ],
              ...
              ExpansionTile(
                ...
                backgroundColor: Colors.grey[100],
                onExpansionChanged: (bool expanding) =>
                    setState(() => this.isExpanded3 = expanding),
                children: [
                  Column(
                    mainAxisAlignment: MainAxisAlignment.center,
                    children: [
              ...
              ExpansionTile(
                ...
                backgroundColor: Colors.grey[100],
                onExpansionChanged: (bool expanding) =>
                    setState(() => this.isExpanded4 = expanding),
                children: [
                  Column(
                    mainAxisAlignment: MainAxisAlignment.spaceAround,
                    children: [
              ...
              ExpansionTile(
                ...
                backgroundColor: Colors.grey[100],
                onExpansionChanged: (bool expanding) =>
                    setState(() => this.isExpanded5 = expanding),
                children: [
                  Row(
                    mainAxisAlignment: MainAxisAlignment.spaceEvenly,
                    children: [
                          ...
                          children: [
                            Padding(
                              ...
                              child: Image.asset(
                                "images/manual.png",
                                color:
                                    manual ? Colors.red[600] : Colors.grey[600],
                                fit: BoxFit.fill,
                                width: 45,
                                height: 50,
                              ),
              ...
              ExpansionTile(
                ...
                backgroundColor: Colors.grey[100],
                onExpansionChanged: (bool expanding) =>
                    setState(() => this.isExpanded6 = expanding),
                children: [
                  Column(
                    mainAxisAlignment: MainAxisAlignment.spaceEvenly,
                    children: [
              ...
              //   backgroundColor: Colors.grey[100],
              //   onExpansionChanged: (bool expanding) =>
              //       setState(() => this.isExpanded7 = expanding),
              //   children: [
              //     Column(
              //       mainAxisAlignment: MainAxisAlignment.center,
              //       children: [
